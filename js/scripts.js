...
$('.readmore').on('click', function(){
	$(this).toggleClass('open'); 
	$('.title_nfts p').each(heightopenclose);
});

$('.sales_toggle').on('click', function(){
    $(this).toggleClass('open'); 
    $('.stats_full').each(heightopenclose);
});

$('.forsaleonly_toggle').on('click', function(){
    $(this).toggleClass('open'); 
});
...
$('#toggle_boosts').on('click', function(){
	$(this).toggleClass('open'); 
    //$('.checkbox_holder').each(heightopenclose);
    $('.checkbox_holder').toggleClass('open');
});

$('#toggle_sales').on('click', function(){
	$(this).toggleClass('open'); 
    $('.sale_history').each(heightopenclose);
});

$('#toggle_owner').on('click', function(){
	$(this).toggleClass('open'); 
    $('.owner').each(heightopenclose);
});

$('#toggle_sidebar_form').on('click', function(){
	$(this).toggleClass('open'); 
    $('.form_wrap').each(heightopenclose);
});
